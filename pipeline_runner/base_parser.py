...
def regex_findall_variables(raw_string: Text) -> List[Text]:
    ...
    while match_start_position < len(raw_string):
        ...
        # print("dollar_match end ", dollar_match.end())
        ...
        if var_match:
            ...
            print("var_match.group(1) ", var_match.group(1))
            print("var_match.group(2) ", var_match.group(2))

            vars_list.append(var_name)
            match_start_position = var_match.end()
            print("var_match.end ", var_match.end())
            continue
...
print("vals ", regex_findall_variables("$1$b$c"))
...
def get_mapping_variable(
    ...
    Raises:
        VariableNotFound: variable is not found.
...
#
#     Raises:
#         FunctionNotFound: function is neither defined in debugtalk.py nor builtin.
#
#     """
